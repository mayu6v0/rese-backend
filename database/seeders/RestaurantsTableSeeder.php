...
class RestaurantsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $param = [
            ...
            'image_url' => 'https://m-rese.s3.ap-northeast-1.amazonaws.com/image/image/sushi.jpg'
        ];
        ...
        $param = [
            ...
            'image_url' => 'https://m-rese.s3.ap-northeast-1.amazonaws.com/image/yakiniku.jpg'
        ];
        DB::table('restaurants')->insert($param);
        $param = [
            'name' => '戦慄',
            ...
            'image_url' => 'https://m-rese.s3.ap-northeast-1.amazonaws.com/image/izakaya.jpg'
        ];
        DB::table('restaurants')->insert($param);
        $param = [
            'name' => 'ルーク',
            ...
            'image_url' => 'https://m-rese.s3.ap-northeast-1.amazonaws.com/image/italian.jpg'
        ];
        DB::table('restaurants')->insert($param);
        $param = [
            'name' => '志摩屋',
            ...
            'image_url' => 'https://m-rese.s3.ap-northeast-1.amazonaws.com/image/ramen.jpg'
        ];
        DB::table('restaurants')->insert($param);
        $param = [
            'name' => '香',
        ...
        $param = [
            ...
            'image_url' => 'https://m-rese.s3.ap-northeast-1.amazonaws.com/image/sushi.jpg'
        ];
        DB::table('restaurants')->insert($param);
        $param = [
            'name' => '晴海',
